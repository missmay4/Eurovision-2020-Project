  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col" md="6" offset-md="3">
        <img class="d-block mx-auto" src="../assets/Rotterdam/Rotterdam.svg" width="700px" height="350px" />
        <p class="par1">
          El Festival de Eurovisión de 2020 iba a ser la edicion número 65 del festival.
          Esta edición iba a ser celebrada en la ciudad de Rotterdam, Paises Bajos, país de origen
    ...
    <div class="row">
      <div class="col" md="6" offset-md="3">
        <p>
          Estaba organizado para ser llevado acabo en dos semifinales, una el 12 y otra el 14 de mayo, y después la gran
          final el 16 de mayo de 2020.
        ...
        <p>
          En lugar de la edición cancelada, la EBU y sus miembros neerlandeses NPO, NOS y AVROTROS organizaron un
          espectáculo
          llamado Eurovision: Europe Shine a Light, para mostrar a los paises selecionados para la gran final el 16 de
          mayo.
